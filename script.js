...
const posts = [
  {
    title: "如何才能挣到1个亿",
    date: "2026-08-15",
    excerpt: "月薪1万要存833年才能攒够一个亿，所以靠打工没戏。本文把目标拆小、路径捋清，教你用正确姿势冲向一个亿。",
    tags: ["暴富", "玄学"],
    emoji: "🤑",
    color: "#ffe0b2",
    url: "post-7.html",
  },
  {
    title: "为什么奶龙是上帝的化身",
    date: "2026-08-14",
    excerpt: "奶龙通体金黄、无所不在、还能治愈人心——这不叫龙，这叫神迹。本文用严谨论证实锤：奶龙是上帝的化身。",
    tags: ["神学", "玄学"],
    emoji: "🐉",
    color: "#ffe082",
    url: "post-6.html",
  ...
  {
    title: "为什么感冒药不能搭配混凝土一起吃",
    date: "2026-08-14",
    excerpt: "感冒药治上呼吸道，混凝土打地基，专业不对口硬凑一起，只会让你的胃变成实心水泥墩子。",
    tags: ["养生", "硬核"],
    emoji: "💊",
    color: "#b3e5fc",
    url: "post-5.html",
